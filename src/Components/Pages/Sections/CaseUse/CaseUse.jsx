...
const CaseUseCard = ({ title, description, quote, author }) => {
  return (
    <div className="bg-blue-950 p-6 rounded-lg shadow-xl border border-gray-700
                     hover:scale-105 transition-transform duration-300 ease-in-out
                    flex flex-col items-start text-left transform hover:-translate-y-2">
      <h3 className="text-2xl font-bold mb-3 text-blue-400">{title}</h3>
      <p className="text-gray-300 text-xl  mb-4 flex-grow">{description}</p>
      {quote && (
